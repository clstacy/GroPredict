...
df = pd.read_csv("../data/raw/hsal/20150517_PQ_3/PQ_batch3_transposed.csv")

print(df.head())


y = df['Strain_PQ'].values
X = np.log(df.drop('Strain_PQ', axis = 1).values) #note log transformation of OD values
